...
gl.loadimage('mni152')
#open overlay: difference mask cluster 0 > cluster 1 (internal structural connectivity)
pathtomask =r'\\wsl.localhost\Ubuntu-20.04\...\nifti_masks\F32_structural_internal_cluster0_minus_cluster1_mask.nii.gz'
...
# save image as png
gl.savebmp(os.path.join(dir, 'structural_internal_cluster0_minus_cluster1.png'))
