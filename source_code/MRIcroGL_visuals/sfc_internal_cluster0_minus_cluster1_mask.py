...
gl.loadimage('mni152')
#open overlay: difference mask cluster 0 > cluster 1 (internal structure-function coupling)
pathtomask =r'\\wsl.localhost\Ubuntu-20.04\...\nifti_masks\F32_sfc_internal_cluster0_minus_cluster1_mask.nii.gz'
