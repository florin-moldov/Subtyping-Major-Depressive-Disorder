...
gl.loadimage('mni152')
#open overlay: difference mask cluster 0 > cluster 1 (internal sfc for sfc_external clustered MDD subjects)
pathtomask =r'\\wsl.localhost\Ubuntu-20.04\...\nifti_masks\F32_sfc_internal_cluster0_minus_cluster1_mask_sfc_external.nii.gz'
...
# save image as png
gl.savebmp(os.path.join(dir, 'sfc_internal_cluster0_minus_cluster1_sfc_external.png'))
