...
gl.loadimage('mni152')
#open overlay: difference mask cluster 0 > cluster 1 (internal structural connectivity for sfc_external clustered MDD subjects)
pathtomask =r'\\wsl.localhost\Ubuntu-20.04\...\nifti_masks\F32_structural_internal_cluster0_minus_cluster1_mask_sfc_external.nii.gz'
...
gl.minmax(1, -0.001, -0.06)
gl.shaderadjust("brighten", 100)
#"a"xial, "c"oronal and "s"agittal "r"enderings
gl.mosaic("A R 0 S R 0; A 0 S 0");
# save image as png
gl.savebmp(os.path.join(dir, 'structural_internal_cluster0_minus_cluster1_sfc_external.png'))
